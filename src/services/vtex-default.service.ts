...
// import { PaymentOperation, VtexStatus, PaymentStatus } from '../interfaces/enums/vtex.enum';
...
//     private transactionRep: VtexPaymentRepository,
...
//       //
//
//       const vtexData: PaymentTransactionDto = {
...
//       };
//
//       const vtexTransaction: PaymentDto = await this.transactionRep.createInitPayment(
//         vtexData,
...
//     try {
//       await sleep(3000);
//       const transaction: PaymentDto = await this.transactionRep.getPayment(paymentId);
//
...
//       };
//
//       await this.transactionRep.createInitPayment(vtexData, PaymentOperation.CONFIRMATION, trxResult);
//
//       await this.transactionRep.updatePaymentStatus(paymentId, PaymentStatus.CONFIRMED);
//
...
//
//     const transaction: PaymentDto = await this.transactionRep.getPayment(cancellationRequest.paymentId);
//
//     //Simular Respuesta
//     const trxResult: CoreTransactionRes = {
//       amount: transaction.amount,
...
//       };
//
//       await this.transactionRep.createInitPayment(vtexData, PaymentOperation.CANCELLATION, trxResult);
//
//       response = {
//         paymentId: cancellationRequest.paymentId,
...
//
//     try {
//       const transaction: PaymentDto = await this.transactionRep.getPayment(refundReq.paymentId);
//
//       //Simular Respuesta
//       const trxResult: CoreTransactionRes = {
//         amount: transaction.amount,
...
//       };
//
//       await this.transactionRep.createInitPayment(vtexData, PaymentOperation.REFUND, trxResult);
//
//       response = {
//         paymentId: refundReq.paymentId,
...
//
//     try {
//       const transaction: PaymentDto = await this.transactionRep.getPayment(settlementReq.paymentId);
//
//       //Simular Respuesta
//       const trxResult: CoreTransactionRes = {
//         amount: transaction.amount,
...
//       };
//
//       await this.transactionRep.createInitPayment(vtexData, PaymentOperation.SETTLEMENT, trxResult);
//
//       response = {
//         paymentId: settlementReq.paymentId,
