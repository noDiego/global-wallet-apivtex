...
export class WalletApiClient{
    ...
    public async payment(data: CreateTransactionReq, origin: string): Promise<CommerceClientDTO> {
        ...
        try {
            const response: AxiosResponse<ResponseDTO<CommerceClientDTO>> = await axios(
                requestConfig,
            );
            if (response.data) {
